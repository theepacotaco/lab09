...
public class SafeInput {
    ...
    public static void main(String[] args) {
        while (true) {
            ...
            String playAgainChoice = scanner.next().trim().toLowerCase();
    ...
    private static void playGame() {
        ...
        while (true) {
            ...
            while (!isValidMove(rowIndex, colIndex)) {
                ...
                rowMove = getRangedInt(new Scanner(System.in), "Enter row (1-3): ", 1, 3);
                colMove = getRangedInt(new Scanner(System.in), "Enter column (1-3): ", 1, 3);
                rowIndex = rowMove - 1;
                colIndex = colMove - 1;
            }
